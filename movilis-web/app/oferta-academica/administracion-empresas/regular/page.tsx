...
export default function AdministracionEmpresasRegularPage() {
    ...
    const mallaCurricular = [
        {
            ...
            materias: [
                ...
                'TICS y Programación en empresas de transporte',
                'Redacción académica',
            ],
        },
        {
            ...
            <section className="bg-gradient-to-br from-[#881E80] to-[#9a2d8f] text-white py-20 md:py-28">
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    ...
                    >
                        ...
                        >
                            Tecnología Superior en Administración de Empresas de Transporte
                        </motion.h1>
                        ...
                        >
                            Con tu carrera lograrás <strong>gestionar, planificar y optimizar</strong> operaciones de empresas de transporte, aplicando criterios técnicos, normativos y tecnológicos. Podrás coordinar flotas, administrar procesos operativos, controlar costos y proponer soluciones que fortalezcan la <strong>eficiencia y sostenibilidad</strong> del sector, actuando con responsabilidad, ética y enfoque estratégico.
                        </motion.p>
                    </motion.div>
                </div>
            </section>
                        ...
                        <div className="flex flex-col md:flex-row gap-6 items-start">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-lg text-gray-700 leading-relaxed">
                                    Empresas públicas y privadas del sector transporte, desempeñándose como administrador de empresas de transporte, coordinador de operaciones, gestor de flotas, planificador de rutas, analista de costos operativos, supervisor de servicios de transporte, así como emprender proyectos propios en el área.
                                </p>
                            </div>
                        </div>
                    </motion.div>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                ...
                                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 flex items-center justify-center min-h-[100px] border-2 border-blue-200 hover:shadow-lg transition-shadow duration-300 col-span-1">
                                    <span className="text-blue-700 font-bold text-center text-sm">Gestión de Flotas</span>
                                </div>
                                ...
                                <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl p-6 flex items-center justify-center min-h-[100px] border-2 border-indigo-200 hover:shadow-lg transition-shadow duration-300 col-span-1">
                                    <span className="text-indigo-700 font-bold text-center text-sm">Sistemas de Transporte</span>
                                </div>
                            </div>
                        </motion.div>
                    </div>
