...
import { Code, Terminal, ArrowRight, BookOpen, Laptop, X, CheckCircle, Award } from 'lucide-react';
        ...
        <main className="min-h-screen flex flex-col lg:flex-row relative">
            ...
            <div className="group relative flex-1 bg-gradient-to-br from-gray-50 to-white flex items-center justify-center p-8 md:p-12 lg:p-16 min-h-[50vh] lg:min-h-screen overflow-hidden transition-all duration-500 hover:bg-gradient-to-br hover:from-gray-100 hover:to-gray-50">
                ...
                <div className="relative z-10 max-w-xl text-center lg:text-left">
                    ...
                    >
                        {/* Icono de Código/Laptop */}
                        <Laptop className="w-12 h-12 md:w-16 md:h-16 text-white" strokeWidth={1.5} />
                    </motion.div>
                    ...
                    >
                        Aprende desde cero: Programación, Inteligencia Artificial y Desarrollo Web con garantía de empleo.
                    </motion.p>
                    ...
                    >
                        {/* CAMBIO DE RUTA AQUI */}
                        <Link href="/oferta-academica/desarrollo-software/regular">
                            <motion.button
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span>Modalidad: 100% En Línea</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-[#F9EB1D] rounded-full"></div>
                            <span className="font-bold text-[#881E80]">¡Trabajo Garantizado!</span>
                        </div>
                    </motion.div>
                </div>
            </div>
            ...
            {/* =========================================================
               OPCIÓN B: VALIDACIÓN (Derecha - Fondo Púrpura/Tech)
               ========================================================= */}
            <div className="group relative flex-1 bg-gradient-to-br from-[#881E80] to-[#2e052a] flex items-center justify-center p-8 md:p-12 lg:p-16 min-h-[50vh] lg:min-h-screen overflow-hidden transition-all duration-500 hover:from-[#9a2d8f] hover:to-[#4a0a44]">
                ...
                >
                    ...
                    Para Programadores con Experiencia
                </motion.div>
                ...
                <div className="relative z-10 max-w-xl text-center lg:text-left">
                    ...
                    >
                        <Terminal className="w-12 h-12 md:w-16 md:h-16 text-[#881E80]" strokeWidth={1.5} />
                    </motion.div>
                    ...
                    {/* Subtítulo Específico de Software */}
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ delay: 0.4, duration: 0.6 }}
                    ...
                    >
                        Demuestra lo que sabes de código y obtén tu título oficial sin cursar materias que ya dominas.
                    </motion.p>
                    ...
                    >
                        {/* CAMBIO DE RUTA AQUI */}
                        <Link href="/oferta-academica/desarrollo-software/validacion">
                            <motion.button
                                whileHover={{ scale: 1.05, x: 5 }}
                                whileTap={{ scale: 0.95 }}
