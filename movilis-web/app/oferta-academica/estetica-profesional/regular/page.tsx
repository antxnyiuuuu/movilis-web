...
export default function EsteticaProfesionalRegularPage() {
            ...
            <section className="bg-gradient-to-br from-[#881E80] to-[#9a2d8f] text-white py-20 md:py-28">
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    ...
                    >
                        ...
                        >
                            Tecnología Superior en Estética Profesional
                        </motion.h1>
                        ...
                        >
                            Con tu Tecnología Superior en Estética Profesional está capacitado para aplicar tratamientos estéticos y de bienestar integral con bases técnicas y éticas, fortaleciendo conocimientos adquiridos por experiencia práctica y ampliando sus oportunidades laborales, de emprendimiento y especialización.
                        </motion.p>
                    </motion.div>
                </div>
            </section>
                        ...
                        <div className="flex flex-col md:flex-row gap-6 items-start">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-lg text-gray-700 leading-relaxed">
                                    Podrás desempeñarte en centros de estética, spas, clínicas dermatológicas, salones de belleza y proyectos propios, brindando servicios estéticos profesionales, tratamientos de bienestar integral y emprendiendo con respaldo técnico y académico.
                                </p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl p-6 flex items-center justify-center min-h-[100px] border-2 border-pink-200">
                                    <span className="text-pink-700 font-bold text-center text-sm">Logos de certificaciones</span>
                                </div>
                            </div>
                        </motion.div>
                    </div>
