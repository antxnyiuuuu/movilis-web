...
export default function EsteticaProfesionalValidacionPage() {
    const [activeTab, setActiveTab] = useState(0);
    const [openAccordion, setOpenAccordion] = useState<number | null>(null);

    // Datos de la malla curricular (Placeholder - a ser actualizados por el usuario)
    const mallaCurricular = [
        {
            nivel: 'Nivel 1',
            modalidad: 'Examen de Validación',
            materias: [
                'Lógica y resolución de problemas computacionales o TIC',
                'Matemáticas o pensamiento lógico',
                'Anatomía y fisiología estética',
                'Normativas y bioseguridad en estética',
                'Aparatología corporal y facial',
                'Estética corporal y protocolos',
            ],
        },
        {
            nivel: 'Nivel 2',
            ...
            materias: [
                ...
                'Química cosmética y fitoterapia',
                'Masoterapia y masofilaxia',
                'Terapias bioenergéticas, relajación y spa',
                'Productos estéticos y su aplicación',
                'Cosmetología para el cuidado de la piel',
            ],
        },
        {
            nivel: 'Nivel 3',
            ...
            materias: [
                ...
                'Semiología estética y cuidado capilar',
                'Electroestética y electroterapia avanzada',
                'Estética corporal avanzada',
                'Estética facial profesional avanzada',
                'Técnicas avanzadas de moldeo y esculpido corporal',
        ...
        },
        {
            ...
            materias: [
                ...
                'Tratamientos estéticos para el cuidado podal',
                'Hábitos para la belleza integral',
                'Terapias alternativas y holísticas en estética',
                'Habilidades de atención en el sector estético',
                'Trabajo de grado',
                'Prácticas laborales 2',
            ],
        },
    ];
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <section className="bg-gradient-to-br from-[#6a1564] to-[#881E80] text-white py-20 md:py-28">
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    ...
                    >
                        ...
                        <div className="mb-8">
                            <p className="text-2xl font-bold text-[#F9EB1D] mb-2">Programa de Validación de conocimientos</p>
                            <p className="text-lg text-white/70 italic">(Colocar texto normativa Jimmy)</p>
                        </div>

                        <p className="text-lg md:text-xl leading-relaxed text-white/90">
                            Este proceso te permite demostrar lo que sabes y comprobar que has alcanzado los objetivos de aprendizaje de una asignatura o cursos, convirtiendo tu experiencia en una oportunidad académica.
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        >
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-4">Niveles 1, 2, 3</h3>
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 text-lg">
                                El estudiante deberá acreditar un nivel de inglés equivalente a A2 del Marco Común Europeo de Referencia para las Lenguas (MCER).
                                Pregunta a tu asesor las opciones
                            </p>
                        </div>
                    </motion.div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    ...
                    >
                        ...
                        <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {[
                                'Título de bachiller',
                                'Cópia de cédula de identidad y papeleta de votación en PDF (Link a modelo)',
                                'Correo electrónico personal',
                                'Presentar la solicutd de ingreso a validación de conociminetos.',
                ...
                <div className="max-w-4xl mx-auto px-6 md:px-12">
                    ...
                    >
                        <div className="text-center mb-8">
                            ...
                            <p className="text-white/80 text-lg">Valor total de la validación de conocimientos: $ 2317,50</p>
                        </div>

                        <div className="text-center mb-10">
                            <div className="inline-block bg-white/10 backdrop-blur-sm rounded-2xl px-10 py-8">
                                <p className="text-5xl md:text-7xl font-bold text-[#F9EB1D]">$ 2317,50</p>
                            </div>
                        </div>

                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-8">
                            <h3 className="text-xl font-bold mb-6 text-center border-b border-white/20 pb-4">Valores detallados:</h3>
                            <div className="space-y-4">
                                <div className="flex justify-between items-center border-b border-white/10 pb-2">
                                    <span className="text-white/80">Valor por cada nivel validado</span>
                                    <span className="font-bold text-xl">$ 530,50</span>
                                </div>
                                <div className="flex justify-between items-center border-b border-white/10 pb-2">
                                    <span className="text-white/80">Matrícula nivel 4</span>
                                    <span className="font-bold text-xl">$ 66,00</span>
                                </div>
                                <div className="flex justify-between items-center border-b border-white/10 pb-2">
                                ...
                                <div className="text-center pt-4">
                                    <p className="text-[#F9EB1D] font-bold italic">Comunicate con tu asesor para más información</p>
                                </div>
                            </div>
                        </div>
            ...
            {/* SECCIÓN 7: Barra de Acción Final */}
